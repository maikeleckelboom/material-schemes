...
<template>
  <div class="flex flex-col">
    <fieldset>
      ...
      <template v-else>
        <button @click="options.sourceColor = toHex(scheme.sourceColorArgb)">
          Enable
        </button>
      </template>
    </fieldset>
    ...
    <fieldset>
      ...
      <template v-else>
        <button @click="options.primary = toHex(scheme.primaryPaletteKeyColor)">
          Enable
        </button>
      </template>
    </fieldset>
    ...
    <fieldset>
      ...
      <template v-else>
        <button @click="options.secondary = toHex(scheme.secondaryPaletteKeyColor)">
          Enable
        </button>
      </template>
    </fieldset>
    ...
    <fieldset>
      ...
      <template v-else>
        <button @click="options.tertiary = toHex(scheme.tertiaryPaletteKeyColor)">
          Enable
        </button>
      </template>
    </fieldset>
    ...
    <fieldset>
      ...
      <template v-else>
        <button @click="options.neutral = toHex(scheme.neutralPaletteKeyColor)">
          Enable
        </button>
      </template>
    </fieldset>
    ...
    <fieldset>
      ...
      <template v-else>
        <button
          @click="options.neutralVariant = toHex(scheme.neutralVariantPaletteKeyColor)"
        >
          Enable
        </button>
      </template>
